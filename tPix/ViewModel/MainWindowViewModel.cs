...
namespace tPix.ViewModel
{
  ...
  public class MainWindowViewModel : ViewModelBase
  {
    ...
    public ObservableCollection<string> Numbers
    {
      ...
      {
        this.numbers = value;
        this.RaisePropertyChangedEvent(nameof(this.Numbers));
      }
    }
    ...
    public int ImagesIndex
    {
      ...
      set
      {
        ...
        this.RaisePropertyChangedEvent(nameof(this.ImagesIndex));
        this.RaisePropertyChangedEvent(nameof(this.ImagePath));
        this.RaisePropertyChangedEvent(nameof(this.ImageDescription));
      }
    }
    ...
    public int ClassesIndex
    {
      ...
      set
      {
        ...
        this.GetNmbs();
        this.GetImages();
        this.RaisePropertyChangedEvent(nameof(this.ClassesIndex));
      }
    }
    ...
    public int NumbersIndex
    {
      ...
      set
      {
        ...
        this.GetImages();
        this.RaisePropertyChangedEvent(nameof(this.NumbersIndex));
      }
    }
    ...
    public int LocationsIndex
    {
      ...
      set
      {
        ...
        this.RaisePropertyChangedEvent(nameof(this.LocationsIndex));
        this.RaisePropertyChangedEvent(nameof(this.CurrentLocation));
      }
    }
    ...
    public int LinesIndex
    {
      ...
      set
      {
        ...
        this.RaisePropertyChangedEvent(nameof(this.CurrentLine));
      }
    }
    ...
    public int CountiesIndex
    {
      ...
      set
      {
        ...
        this.RaisePropertyChangedEvent(nameof(this.CurrentCounty));
      }
    }
    ...
    public int RegionsIndex
    {
      ...
      set
      {
        ...
        this.RaisePropertyChangedEvent(nameof(this.CurrentRegion));
      }
    }
    ...
    public int Big4RegionsIndex
    {
      ...
      set
      {
        ...
        this.RaisePropertyChangedEvent(nameof(this.CurrentBig4));
      }
    }
    ...
    public LocationType LocationSelector {
      ...
      set
      {
        this.SelectLocationSelector(value);
      }
    }
    ...
    public ICommand ConfigLocationsCommand
    {
      get;
      private set;
    }
      ...
      bool forceTrue = false)
    {
      ...
      this.GetImages();
      this.RaisePropertyChangedEvent(nameof(this.LocationSelector));
    }
